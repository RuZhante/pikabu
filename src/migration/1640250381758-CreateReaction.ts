...
export class CreateReaction1640250381758 implements MigrationInterface {
    name = 'CreateReaction1640250381758'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "reactions" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "postId" integer NOT NULL, "reaction" character varying NOT NULL, CONSTRAINT "PK_0b213d460d0c473bc2fb6ee27f3" PRIMARY KEY ("id"))`);
